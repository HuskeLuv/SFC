 ...
 *
 * GET  /api/calendar?de=AAAA-MM-DD&ate=AAAA-MM-DD → { eventos, periodo, fontesComErro }
...
import { montarAgenda, parsePeriodo } from '@/services/calendario/agenda';
...
export const GET = withErrorHandler(async (request: NextRequest) => {
  ...
  const { eventos, fontesComErro } = await montarAgenda(targetUserId, periodo);
