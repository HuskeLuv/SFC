...
export const InflationPedroRow: React.FC<InflationPedroRowProps> = ({ 
  ...
  return (
    <TableRow className="h-6 bg-[#D9D9D9]" style={{ fontFamily: 'Calibri, sans-serif', fontSize: '12px' }}>
      <TableCell 
        className="px-2 font-bold text-black border-t border-b border-l border-black dark:border-black text-xs w-32 text-left h-6 leading-6 whitespace-nowrap"
        style={{ 
          position: 'sticky',
          left: 0,
          zIndex: 50,
      ...
      <TableCell 
        className="px-2 font-bold text-black border-t border-b border-black dark:border-black text-xs w-40 h-6 leading-6 whitespace-nowrap"
        style={{ 
          position: 'sticky',
          left: '128px',
          zIndex: 51,
      ...
      <TableCell 
        className="px-2 font-bold text-black border-t border-b border-black dark:border-black text-xs w-16 text-center h-6 leading-6 whitespace-nowrap"
        style={{ 
          position: 'sticky',
          left: '288px',
          zIndex: 52,
      ...
      <TableCell 
        className="px-2 font-bold text-black border-t border-b border-r border-black dark:border-black text-xs w-16 text-right h-6 leading-6 whitespace-nowrap"
        style={{ 
          position: 'sticky',
          left: '352px',
          zIndex: 53,
