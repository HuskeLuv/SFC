...
export const AddRowForm: React.FC<AddRowFormProps> = ({
  ...
  <TableRow
    className="h-6 bg-blue-50 dark:bg-blue-800"
  ...
  >
    ...
    {Array.from({ length: 12 }).map((_, i) => (
      <TableCell
        key={i}
        className="px-1 text-right h-6 leading-6 text-xs bg-[#F2F2F2] dark:bg-gray-800 border-t border-b border-l border-r border-white dark:border-gray-900"
        style={{ minWidth: '3rem' }}
      >
        -
      </TableCell>
    ...
    <TableCell className="px-0 w-[10px] h-6 leading-6 text-xs bg-white dark:bg-gray-900"></TableCell>
    <TableCell
      className="px-2 text-right h-6 leading-6 text-xs bg-[#F2F2F2] dark:bg-gray-800 border-t border-b border-l border-r border-white dark:border-gray-900"
      style={{ minWidth: '4rem' }}
    >
      -
    </TableCell>
