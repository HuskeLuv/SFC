...
export const AddRowForm: React.FC<AddRowFormProps> = ({ 
  ...
  <TableRow className="bg-blue-50 dark:bg-blue-800">
    <TableCell className="px-2 py-2 border border-black dark:border-black w-32 text-left">
    ...
    <TableCell className="px-2 py-2 border border-black dark:border-black w-16 text-right">
      -
    </TableCell>
    {Array.from({ length: 12 }).map((_, i) => (
      <TableCell key={i} className="px-1 py-2 border border-black dark:border-black w-12 text-right">
        -
      </TableCell>
    ))}
    <TableCell className="px-2 py-2 border border-black dark:border-black w-16 text-right">
