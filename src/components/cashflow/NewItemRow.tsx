  ...
  return (
    <TableRow className="hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors bg-blue-50 dark:bg-blue-800">
      ...
      {Array.from({ length: 12 }).map((_, index) => (
        <TableCell key={index} className="px-1 py-2 font-normal text-gray-800 border border-black dark:border-black text-xs dark:text-gray-400 w-12 text-right cursor-default">
          {formatCurrency(0)}
        </TableCell>
      ))}
