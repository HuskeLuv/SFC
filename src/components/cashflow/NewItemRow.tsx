...
export const NewItemRow: React.FC<NewItemRowProps> = ({ item, group: _group }) => {
  ...
  return (
    <TableRow
      className="h-6 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors bg-blue-50 dark:bg-blue-800"
