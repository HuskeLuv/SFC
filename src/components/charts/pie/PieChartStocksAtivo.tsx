...
import { CarteiraStockAlocacaoAtivo } from '@/types/carteiraStocks';
...
interface PieChartStocksAtivoProps {
  data: CarteiraStockAlocacaoAtivo[];
  isDarkMode?: boolean;
}

const PieChartStocksAtivo: React.FC<PieChartStocksAtivoProps> = ({ data, isDarkMode = false }) => {
  ...
  return (
    <div className="flex justify-center">
      <div id="chartStocksAtivo" className="w-full">
...
export default PieChartStocksAtivo;
