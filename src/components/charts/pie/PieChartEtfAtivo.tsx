...
import { EtfAlocacaoAtivo } from '@/types/etf';
...
interface PieChartEtfAtivoProps {
  data: EtfAlocacaoAtivo[];
  isDarkMode?: boolean;
}

const PieChartEtfAtivo: React.FC<PieChartEtfAtivoProps> = ({ data, isDarkMode = false }) => {
  ...
  return (
    <div className="flex justify-center">
      <div id="chartEtfAtivo" className="w-full">
...
export default PieChartEtfAtivo;
