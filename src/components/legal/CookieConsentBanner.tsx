...
export default function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="print:hidden fixed bottom-[calc(var(--mf-bottom-nav-h,0px)+1rem)] left-4 right-4 z-[9999] mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white p-4 shadow-2xl dark:border-gray-700 dark:bg-gray-900 sm:left-auto sm:right-4 sm:p-5"
    >
