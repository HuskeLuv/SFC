...
describe('classificarIntencao', () => {
  it.each([
    ...
    ['Meu aluguel é 2.500 por mês', 'lancamento'],
    ['A faculdade custa R$ 890 todo mês', 'lancamento'],
    ['Escola: 1.200 mensal', 'lancamento'],
    ['Quanto gasto por mês com escola?', 'gasto_categoria'],
