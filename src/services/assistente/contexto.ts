...
import {
  ...
  type CashGroupLike,
  type LinhaEditavel,
} from '@/services/cashflow/linhasEditaveis';

// Movidos para services/cashflow/linhasEditaveis (sem next/server: o lançamento rápido do celular
// usa no cliente). Reexportados para quem já importava daqui.
export { listarLinhasEditaveis };
export type { CashGroupLike, LinhaEditavel };
