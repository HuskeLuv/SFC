...
## Fase 2 — pendências leves (26/09/2026)

- Ponto âmbar (#D97706/#FBBF24) no "% da receita" entre 80–90% e nos selos "Atenção" (mesmo âmbar do Quanto Falta da fase 1) — fora da paleta restrita; confirmar com o Wellington.
- Sheet do grupo sem "Recolher/Expandir" (a faixa recolhe); flash da linha pode não acontecer na 1ª edição de linha de template (o id muda com a personalização).
